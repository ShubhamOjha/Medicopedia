...
%>
<form action="/Medicopedia/DocEdit" method="post">
<table>
...
<tr><td>Experience</td><td><input type="text" value="<%=rs.getString("experience")%>" name="exp" ></td>
<tr><td>Qualification</td><td><input type="text" value="<%=rs.getString("qualification")%>" name="ql" ></td>
